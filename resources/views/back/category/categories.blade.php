...
<main class="flex-1 p-6">
    ...
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-xl font-bold">Recent Categories</h2>
        <label for="createModalToggle" class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer">
            Create
        </label>
    </div>
        ...
        <table class="min-w-full bg-white border-collapse">
            <thead class="bg-gray-800 text-white">
                <tr>
                    ...
                    <th class="py-3 px-4 text-left uppercase font-medium text-sm">Slug</th>
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 text-sm">{{ $item->slug }}</td>
